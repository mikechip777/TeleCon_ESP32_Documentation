...
\subsection*{2 --- Obtener el sketch de arranque}

En Inicio, toca el icono de documentos de \ui{Panel de control}
(o abre \ui{Codigos y Documentos} desde ese módulo).
Comparte o guarda el ZIP Classic del DevKit, cópialo al ordenador y abre
la carpeta del \texttt{.ino} en Arduino IDE.

\shot{S02}{s02_codes.png}{Vertical, tema claro}
{Códigos y documentos de Panel de control. Deben verse el PDF de esta guía,
la guía rápida y la fila del ZIP Classic del ESP32. Interfaz en español.}
...
\subsection*{3 --- Ajustar y conectar}
...
{Ajustes de Panel de control. Tipo de usuario Predeterminado seleccionado.
Sección Conexión con Bluetooth + Classic + Simple (líneas de texto).
Sin opciones Avanzado desplegadas.}
...
\begin{itemize}[leftmargin=1.4cm]
  \item \ui{Codigos y Documentos} --- este PDF, una guía rápida y el ZIP
        que coincide con placa + modo elegidos en ajustes.
...
La entrada a \ui{Vehículo RC}, los enlaces Avanzado y las vistas extra del
centro (Cámara, Radar, CSV de sesión) usan monedas o suscripción Pro.

El brillo dorado en una tarjeta bloqueada es el regalo explorador: un
anuncio corto desbloquea ese módulo Pro unas horas.

\shot{S14}{s14_coin_unlock.png}{Vertical, diálogo de desbloqueo}
{Diálogo de desbloqueo con monedas para Vehículo RC o ajustes Avanzado.
Muestra precios y el nombre del módulo. Interfaz en español.}
...
\appendix
\section{Lista de capturas}
\label{sec:shots}

Sustituye cada caja amarilla por el archivo del encabezado.
Prefiere la UI en español para este PDF (inglés para el PDF EN),
tema claro, recortada a la app (excepto S04 y S09, que son hojas del sistema).

\begin{center}
\renewcommand{\arraystretch}{1.18}
\begin{tabular}{>{\ttfamily}c
                >{\raggedright\arraybackslash\ttfamily\scriptsize}p{4.6cm}
                >{\raggedright\arraybackslash}p{6.2cm}}
\rowcolor{TblHead}
\textcolor{white}{\bfseries ID} &
\thc{Archivo} & \thc{Toma} \\
S01 & s01\_home.png & Inicio, no conectado, ambas tarjetas. \\
\rowcolor{TblTelem}
S02 & s02\_codes.png & Códigos y documentos, Panel de control. \\
S02b & s01\_serial.png & Monitor Serie Arduino, banner Classic Simple. \\
\rowcolor{TblTelem}
S03 & s03\_settings\_default.png & Ajustes: Predeterminado + Classic Simple. \\
\rowcolor{TblTelem}
S04 & s04\_permission.png & Diálogo Android Bluetooth / cercanos. \\
S05 & s05\_bluetooth\_scan.png & Lista de escaneo con ESP32-TC-RC-BT-Simple. \\
\rowcolor{TblTelem}
S06 & s06\_home\_connected.png & Inicio, Conectado. \\
S07 & s07\_control\_panel.png & HUD horizontal del Panel de control. \\
\rowcolor{TblTelem}
S08 & s08\_home\_help.png & Diálogo Ayuda rápida. \\
S09 & s09\_wifi\_join.png & Wi-Fi del sistema unido al SoftAP CAM. \\
\rowcolor{TblTelem}
S10 & s10\_panel\_settings.png & Joystick Muelle / Retención. \\
S11 & s11\_center\_picker.png & Selector de pantalla central. \\
\rowcolor{TblTelem}
S12 & s12\_rc\_vehicle.jpg & HUD Vehículo RC + cámara. \\
S13 & s13\_vehicle\_settings.png & Ajustes CAM Predeterminado. \\
\rowcolor{TblTelem}
S14 & s14\_coin\_unlock.png & Diálogo de desbloqueo con monedas. \\
\end{tabular}
\end{center}
